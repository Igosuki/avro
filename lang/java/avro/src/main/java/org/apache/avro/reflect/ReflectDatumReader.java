...
public class ReflectDatumReader<T> extends SpecificDatumReader<T> {
  ...
  protected Object newArray(Object old, int size, Schema schema) {
    ...
    if (elementClass == null) {
      ...
      Conversion<?> elementConversion = getConversionFor(schema.getElementType().getLogicalType());
  ...
  private Object readObjectArray(Object[] array, Schema expectedType, long l,
    ...
    Conversion<?> conversion = getConversionByClass(array.getClass().getComponentType(), logicalType);
    int index = 0;
